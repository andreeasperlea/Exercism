...
export function assertHasId(object) {
 if (!isObject(object) || typeof object.id === 'undefined') {
    throw new Error('Object is missing an "id" property or method.');
  }
}
...
export function hasDefinedType(object) {
  if (!isObject(object)) return false;
  return (
    Object.prototype.hasOwnProperty.call(object,'type') && (typeof object.type!== 'undefined')
  )
}
